...
Simple Demography 4 :: admixture from iS2R2 to S1 AND admixture from R3 to S1
...
while True:
    ...
    T_admix_2 =  int(np.random.uniform(generation_time, min(T_1, T_3), 1))
    T_admix_3 =  int(np.random.uniform(generation_time, min(T_2, T_3), 1))
    alpha = np.random.uniform(0, 1, 1)[0]
    alpha_2 = np.random.uniform(0, 1, 1)[0]
    alpha_3 = np.random.uniform(0, 1, 1)[0]
    
    if T_1 > T_2 > T_admix_3 > T_4 > T_admix and T_1 > T_2 > T_3 > T_admix_3 > T_admix and T_1 > T_2 > T_3 > T_admix_2 > T_admix:
        break

# Demography Parameters
# Output simulation paramters table
sim_params_table = [["T_0_gen", "T_1_gen", "T_2_gen", "T_3_gen", "T_4_gen", "T_admix_gen", "alpha_S1", "T_admix2_gen", "alpha_2", "T_admix3_gen", "alpha_3", "DTWFgens", "generation_time", "rep", "seed"],
                 [T_0 / generation_time, T_1 / generation_time, T_2 / generation_time, T_3 / generation_time, T_4 / generation_time, T_admix / generation_time, alpha, T_admix_2 / generation_time, alpha_2, T_admix_3 / generation_time, alpha_3, DTWFgens, generation_time, iteration, seed]]
...
# Admixture from S2R2 to S1
demography.add_mass_migration(time=T_admix_3 / generation_time, source="R2S2", dest="S1", proportion=alpha_3)
demography.add_migration_rate_change(time=T_admix_3 / generation_time, rate=0) 
...
# Output simulation paramters table
table = [["T_0_gen", "T_1_gen", "T_2_gen", "T_3_gen", "T_4_gen", "T_admix_gen", "alpha_S1", "T_admix2_gen", "alpha_2", "T_admix3_gen", "alpha_3", "DTWFgens", "generation_time", "rep", "seed", "N_ts_trees", "N_ts_nodes", "N_ts_edges"],
                 [T_0 / generation_time, T_1 / generation_time, T_2 / generation_time, T_3 / generation_time, T_4 / generation_time, T_admix / generation_time, alpha, T_admix_2 / generation_time, alpha_2, T_admix_3 / generation_time, alpha_3, DTWFgens, generation_time, iteration, seed, ts.num_trees, ts.num_nodes, ts.num_edges]]
