...
while True:
    ...
    T_admix_2 =  int(np.random.uniform(generation_time, min(T_2, T_3), 1))
...
# Admixture from R2S2 to S1
demography.add_mass_migration(time=T_admix_2 / generation_time, source="R2S2", dest="S1", proportion=alpha_2)
