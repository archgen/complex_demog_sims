...
Simple Demography 2 :: admixture from R3 to S1
"""
...
while True:
    ...
    if T_1 > T_2 > T_3 > T_admix_2 > T_admix and T_1 > T_2 > T_4 > T_admix:
        break
...
sim_params_table = [["T_0_gen", "T_1_gen", "T_2_gen", "T_3_gen", "T_4_gen", "T_admix_gen", "alpha_S1", "T_admix2_gen", "alpha_2", "DTWFgens", "generation_time", "rep", "seed"],
                 [T_0 / generation_time, T_1 / generation_time, T_2 / generation_time, T_3 / generation_time, T_4 / generation_time, T_admix / generation_time, alpha, T_admix_2 / generation_time, alpha_2, DTWFgens, generation_time, iteration, seed]]
...
# Admixture from R3 to S1
demography.add_mass_migration(time=T_admix_2 / generation_time, source="R3", dest="S1", proportion=alpha_2)
demography.add_migration_rate_change(time=T_admix_2 / generation_time, rate=0) 
...
# Output simulation paramters table
table = [["T_0_gen", "T_1_gen", "T_2_gen", "T_3_gen", "T_4_gen", "T_admix_gen", "alpha_S1", "T_admix2_gen", "alpha_2", "DTWFgens", "generation_time", "rep", "seed", "N_ts_trees", "N_ts_nodes", "N_ts_edges"],
                 [T_0 / generation_time, T_1 / generation_time, T_2 / generation_time, T_3 / generation_time, T_4 / generation_time, T_admix / generation_time, alpha, T_admix_2 / generation_time, alpha_2, DTWFgens, generation_time, iteration, seed, ts.num_trees, ts.num_nodes, ts.num_edges]]
