...
hapmap = rbindlist(lapply(1:12, function(x) fread(paste0("./HapMapData/genetic_map_HapMapII_GRCh37/genetic_map_GRCh37_chr", x, ".txt"))))
...
options(scipen = 999)
write.table(hapmap_out, file = "./snakemake/project__complex_msp_simulation/input/rate_map_genetic_map_HapMapII_GRCh37_Chrs1_12__log2recom.txt",
