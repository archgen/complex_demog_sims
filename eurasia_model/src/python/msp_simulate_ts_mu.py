...
table = [["DTWFgens", "rep", "seed", "ts_length", "N_ts_mu_trees", "N_ts_mu_nodes", "N_ts_mu_edges", "N_ts_mu_sites", "N_ts_mu_mutations", "mutation_rate"],
                 [DTWFgens, iteration, seed, ts.sequence_length, ts_mu.num_trees, ts_mu.num_nodes, ts_mu.num_edges, ts_mu.num_sites, ts_mu.num_mutations, args['mutation_rate']]]
